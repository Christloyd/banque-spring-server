...
img_Date_UP.src="images/date_icon.gif";

img_Date_OVER=new Image();
img_Date_OVER.src="images/date_icon.gif";

img_Date_DOWN=new Image();
img_Date_DOWN.src="images/date_icon.gif";
...
function Calendar(whatMonth,whatYear) {
    ...
    output += '<a href="javascript:clearDay();">';
    output += '<img name="calbtn1" src="images/btn_del_small.gif" border="0" width="12" height="10">'
    output += '</a>&nbsp;&nbsp;<a href="javascript:scrollMonth(-1);" class="cal-DayLink">&lt;</a>&nbsp;<SELECT class="cal-TextBox" NAME="cboMonth" onChange="changeMonth();">';
...
//var names     = new makeArray0('Janvier','Fevrier','Mars','Avril','Mai','Juin','Juillet','Aout','Septembre','Octobre','Novembre','Decembre');
