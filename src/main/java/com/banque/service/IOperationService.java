...
public interface IOperationService {
	 ...
	 */
	public abstract IOperationEntity select(Integer unUtilisateurId,
			Integer unCompteId, Integer uneOperationId)
	 ...
	 *             si un probleme survient
	 */
	public abstract List<IOperationEntity> selectAll(Integer unUtilisateurId,
	 ...
	 *             si un probleme survient
	 */
	public abstract List<IOperationEntity> selectCritere(
			Integer unUtilisateurId, Integer unCompteId, Date unDebut,
			Date uneFin, boolean pCredit, boolean pDebit)
			throws EntityIntrouvableException, AucunDroitException,
			NullPointerException, ErreurTechniqueException;
	 ...
	 *             si un probleme survient
	 */
	public abstract List<IOperationEntity> faireVirement(
			Integer unUtilisateurId, Integer unCompteIdSrc,
			Integer unCompteIdDst, Double unMontant)
			throws EntityIntrouvableException, AucunDroitException,
