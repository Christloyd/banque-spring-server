...
public interface IDAO<T extends IEntity> {
	 ...
	 *             si une erreur survient
	 */
	public abstract boolean delete(T pUneEntite, Connection connexion)
			throws ExceptionDao;
	 ...
	 *             si une erreur survient
	 */
	public abstract T select(Object pUneClef, Connection connexion)
			throws ExceptionDao;
	 ...
	 *
	 * @return la connexion sur la base.
	 * @throws ExceptionDao
	 *             si une erreur survient
	 */
